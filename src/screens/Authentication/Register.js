...
import { postRegister } from "../../service/authentication/registerAPI";
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              ...
              {/* Modal title */}
              {isSuccess ? (
                <Text style={[styles.modalTitle, {color: 'green'}]}>Thông báo</Text>
              ) : (
                <Text style={[styles.modalTitle, {color: 'red'}]}>Thông báo</Text>
              )}
              {/* Modal message */}
