...
import AddCarePackage from "../../../components/app/myBlockLand/AddCarePackage";
...
export function MyFarmEdit({ navigation }) {
  ...
  const [isAddMyCarePackageModalVisible, setIsAddMyCarePackageModalVisible] = useState(false);
  const [isAddNewCarePackageModalVisible, setIsAddNewCarePackageModalVisible] = useState(false);
